...
gdal_translate -of Gtiff -co PREDICTOR=2 -co COMPRESS=LZW -ot Int32 stripped.tiff int32lzw_predictor.tiff
gdal_translate -of Gtiff -co PREDICTOR=2 -co COMPRESS=LZW -ot Float32 stripped.tiff float32lzw_predictor.tiff
gdal_translate -of Gtiff -co PREDICTOR=2 -co COMPRESS=LZW rgb.tiff rgblzw_predictor.tiff
