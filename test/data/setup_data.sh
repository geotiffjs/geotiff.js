...
gdal_translate -of Gtiff -co PREDICTOR=2 -co COMPRESS=LZW -ot Int32 stripped.tiff Int32LzwPredictor.tiff
gdal_translate -of Gtiff -co PREDICTOR=2 -co COMPRESS=LZW -ot Float32 stripped.tiff Float32LzwPredictor.tiff
gdal_translate -of Gtiff -co PREDICTOR=2 -co COMPRESS=LZW rgb.tiff rgbLzwPredictor.tiff
